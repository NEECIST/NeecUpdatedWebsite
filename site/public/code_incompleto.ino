...
{
  if (digitalRead(/*completar*/) == 0) return(CHOICE_2ND_RED); 
  else if (digitalRead(/*completar*/) == 0) return(CHOICE_1ST_RED); 
  else if (digitalRead(/*completar*/) == 0) return(CHOICE_YELLOW); 
  else if (digitalRead(/*completar*/) == 0) return(CHOICE_GREEN);
