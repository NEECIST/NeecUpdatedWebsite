  ...
  data() {
      return {
        cardList: [
            ...
            {name:'LevitaNEEC',subtitle:'(Em desenvolvimento)',desc:'', image:levitaNEEC},
            ...
            {name:"Tir'o NEEC",subtitle:'Testa a tua pontaria contra os teus amigos!',desc:'Com o uso de um neecduino, resistências LDR e um laser, criámos um jogo de laser tag solo. As pontuações atingidas dentro de um limite de tempo são utilizadas em eventos do NEEC.', image:tiro},
